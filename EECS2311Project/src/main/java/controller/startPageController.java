...
public class startPageController {
	...
	public void initialize() {
		...
		FadeTransition ft3 = new FadeTransition(Duration.millis(1000), settings);
...
//		rt2.play();
	...
	@FXML
	protected void launchExtendedSettings(ActionEvent event) throws Exception {
		VennDiagram.advancedSettings.display("Advanced Settings");
	}
	...
	/*
	 * Method activates when the folder is clicked on the startpage. The user will
	 * be prompted to select a file to load into the program. FileChooser -> opens
	 * up a prompt for users to select a file selectedFile -> is the actual file
	...
	/*
	 * Reads an XLSX file and iterates over all rows an columns. Only accepts
	 * numeric and string characters.
	 */
